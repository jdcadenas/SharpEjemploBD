...
* **Nombre 1:** Zeze Crespo
* **Nombre 2:** Laura Vargas
...
* *R:* Al eliminar un modulo de la tabla modulo, se eliminaran automaticamente todas las preguntas asociadas con el modulo de la tabla pregunta 
...
* *R:* Es obligatorio porque ambos campos deben ser compatibles a nivel binario para que el servidor de la base de datos pueda establecer el vinculo
...
* *R:* Primeo revisariamos la consulta SQL debido a que me está conectando pero la consulta vuelve vacia, así que es probable que la sentencia tenga un error de logica
...
* *R:* La ventaja principal es la seguridad e integridad de datos para garantizar que el valor solo de lectura 
