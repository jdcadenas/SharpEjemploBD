...
* **Nombre 1:** Angel Rodríguez
* **Nombre 2:** Luis Álvarez
...
* *R:* Al eliminar un módulo, todas las preguntas asociadas a ese id_modulo se borrarán automáticamente
...
* *R:* Porque para establecer una relación ambos campos deben ser compatibles
...
* *R:* Se revisa primero la consulta SQL
...
* *R:* La ventaja principal es la integridad de datos y seguridad
