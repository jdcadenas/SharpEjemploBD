...
//			string nombre_es = fila.Cells["nombre_es"].Value.ToString();
//			string nombre_en = fila.Cells["nombre_en"].Value.ToString();
//
//			using (ModuloNuevo  frmEditar = new ModuloNuevo(id, nombre_es, nombre_en))
//			{
//				
...
//		}
		...
		void BtnVerPreguntasClick(object sender, EventArgs e)
		{
			...
			string nombreMod = dgvModulos.SelectedRows[0].Cells["nombres_es"].Value.ToString();
